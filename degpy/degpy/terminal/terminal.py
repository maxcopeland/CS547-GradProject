...
class Terminal:
    ...
    def __init__(self, file_path, events, event_timestamps):
        ...
        self.encoded_target, self.unique_labels = self._get_encoded_and_unique_labels()
    ...
    def _get_encoded_and_unique_labels(self):
        ...
        for lab in self.target:
            ...
            if lab[:-1] not in unique_labels and lab != 'Starting Recording':
                unique_labels.append(lab[:-1])
    ...
    def get_target_binary_matrix(self):
        ...
        return self.unique_labels, target_binary_matrix
